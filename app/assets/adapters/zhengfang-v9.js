(function (root) {
  ...
  const detect = input => {
    ...
    const gupt = signals.origin === "https://www.gupt.edu.cn";
    if (gupt) { confidence += 5; evidenceCodes.push("PROFILE_ORIGIN_GUPT"); }
    ...
    return Object.freeze({outcome, family: FAMILY, version: VERSION, confidence, adapterId: ID, evidenceCodes, schoolProfileCandidates: gupt ? ["gupt"] : []});
  };
